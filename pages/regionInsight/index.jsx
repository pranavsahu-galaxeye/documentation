...
//This function gives the MasterGeoJSON data from farm status
//It create a seperate GeoJSON object for each farm
...
function RegionInsight() {
	const { orderId, insightId, mandalId, villageId } = useParams();
	...
	useEffect(() => {
		//Update the current order and InsightsIDs of the state
		SET_ORDER_ID_FOR_CURRENT_ORDER(orderId);
		SET_INSIGHT_ID_FOR_CURRENT_ORDER(insightId);
		console.log(orderId, insightId);
